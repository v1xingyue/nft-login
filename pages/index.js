        ...
        <div className="p-6 max-w-3xl h-80 mx-auto bg-white rounded-xl shadow-lg flex items-center space-x-5 space-y-3" >
            ...
            <div className='h-32'>
                ...
                <div className="m-3 space-x-3">
                    ...
                    }} className="px-4 py-1 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2">连接钱包</button>
                    <button
                        onClick={async () => {
